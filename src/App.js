      ...
      <div className="explanation">
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            ...
            considered overbought when above 70 and oversold when below 30. Try
            to open a long position when the RSI is oversold and the price is
            rising. This happens when the RSI is below a level of 30. Try to
            open a short position when the RSI is overbought and the price is
            falling. This happens when the RSI is above a level of 70. The RSI
            can also be used to identify the general trend. If the RSI is
        ...
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            ...
            by traders that gives the average price a security has traded at
            throughout the day, based on both volume and price. The VWAP is
            calculated by adding the dollars traded for every transaction (price
            multiplied by number of shares traded) and then dividing by the
            total shares traded for the day. The VWAP is displayed as a line
            graph that moves throughout the trading day.
          </Accordion.Body>
        </Accordion.Item>
        </Accordion>
      </div>
